...
class UsdSceneBuilder:
    ...
    def build_scene(self):
        ...
        try:
            ...
            if not HAS_USD:
                # Create a placeholder file with scene description in USDA format
...
{{
    ...
    # Texture image used would have been: {latest_image}
...
""")
                logger.info(f"Created placeholder USD file at {self.output_file} (pxr not available)")
                return True
